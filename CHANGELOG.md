...
- Integration boundary: the supplied legacy Project settings still resolve the manifest and are compatible. The replacement `PROJECT-INSTRUCTIONS.md` must be applied manually to settings when no settings-edit capability is available.
