...
- Status/outcome: unresolved; fresh submaximal field efficiency and one well-tolerated approximately one-hour run are supported subfindings, while longer-distance durability, bike-to-run cost and the specific speed limiter remain unresolved. RUN-E is activated in the confirmed queue but not yet completed.
