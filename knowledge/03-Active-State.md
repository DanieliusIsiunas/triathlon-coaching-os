...
- **Post-race recovery:** no testing, long work, hard work or performance-project activation until the next-morning response to the return run is known.
...
| Optional | Rest or 10-30 minutes easy walking. | Keep movement easy until the review is complete. This item does not activate training progression. |
