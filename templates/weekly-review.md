...
- Previous decision and expected response:
- Observed response, including next-day effects and next key-session quality:
- What improved, protocol comparability and uncertainty:
- Current limiter, alternatives and evidence that could change the conclusion:
...
- Minimum/target/maximum where useful; dependencies and what can move:
- Missing inputs, conditional gates and pending benchmark activation:
- Existing confirmed queue versus proposed replacement; confirmation status:

## Persistence and system review
